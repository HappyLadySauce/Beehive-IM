...
import (
	...
	"github.com/HappyLadySauce/Beehive-IM/services/conversation/internal/server"
...
var configFile = flag.String("f", "etc/beehiveim.conversation.yaml", "the config file")
