...
const file_notification_proto_rawDesc = "" +
	"\n" +
	"\x12notification.proto\x12\x17beehive_im.notification\"\x0f\n" +
	"\rHealthRequest\"(\n" +
	"\x0eHealthResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status2p\n" +
	"\x13NotificationService\x12Y\n" +
	"\x06Health\x12&.beehive_im.notification.HealthRequest\x1a'.beehive_im.notification.HealthResponseB\x06Z\x04./pbb\x06proto3"
...
var file_notification_proto_goTypes = []any{
	(*HealthRequest)(nil),  // 0: beehive_im.notification.HealthRequest
	(*HealthResponse)(nil), // 1: beehive_im.notification.HealthResponse
}
var file_notification_proto_depIdxs = []int32{
	0, // 0: beehive_im.notification.NotificationService.Health:input_type -> beehive_im.notification.HealthRequest
	1, // 1: beehive_im.notification.NotificationService.Health:output_type -> beehive_im.notification.HealthResponse
