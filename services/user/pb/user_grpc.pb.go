...
const (
	UserService_GetUser_FullMethodName       = "/beehive_im.user.UserService/GetUser"
	UserService_BatchGetUsers_FullMethodName = "/beehive_im.user.UserService/BatchGetUsers"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "beehive_im.user.UserService",
